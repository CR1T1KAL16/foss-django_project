...
urlpatterns = [
    ...
    path("", views.LandingPageView.as_view(), name="choice"),
    path("signin/index.html/", views.IndexView.as_view(), name="index"),
    ...
    path("list/<int:list_id>/", views.ItemListView.as_view(), name="list"),
    path("index.html/",views.ListListView.as_view(), name="indexx"),
]
